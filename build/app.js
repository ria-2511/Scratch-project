...
var MidArea = function MidArea(_ref) {
  var setActiveEvents = _ref.setActiveEvents;
  var _useContext = (0,react.useContext)(ActiveEventsContext),
    activeEvents = _useContext.activeEvents;
  var currentEvents = _toConsumableArray(activeEvents);
...
/* harmony default export */ var MidArea_MidArea = (MidArea);
;// CONCATENATED MODULE: ./src/components/CatSprite.jsx

var CatSprite = function CatSprite(_ref) {
  var className = _ref.className;
  return /*#__PURE__*/react.createElement("div", {
    id: "sprite",
    className: "flex-none absolute ".concat(className),
    draggable: "true"
...
/* harmony default export */ var components_CatSprite = (CatSprite);
;// CONCATENATED MODULE: ./src/helpers/basicHelpers.js
function calculateDimensions(activeEvents) {
  var dimensions = {
    x: 0,
    y: 0,
    angle: 90
  };
  var control = function control(eventId) {
    switch (eventId) {
...
var getAnimationsString = function getAnimationsString(dimensions) {
  var baseString = 'transform transition delay-1500';
  var xData = dimensions && dimensions.x / 10;
  var anglesData = dimensions && (dimensions.angle - 90) / 15;
  var animationsStrings = {
    xClass: "ml-".concat(xData * 4),
    yClass: 'ml-4',
    angleClass: "".concat(anglesData < 0 ? '-' : '', "rotate-").concat(Math.abs(anglesData * 15))
  };
  if (dimensions && dimensions.x > 0) {
    baseString = "".concat(baseString, " ").concat(animationsStrings.xClass);
  }
  if (dimensions && dimensions.angle !== 180) {
    baseString = "".concat(baseString, " ").concat(animationsStrings.angleClass);
  }
  return baseString;
};
;// CONCATENATED MODULE: ./src/components/PreviewArea/PreviewArea.jsx




var PreviewArea = function PreviewArea() {
  var _useContext = (0,react.useContext)(ActiveEventsContext),
    dimensions = _useContext.dimensions;
  var className = getAnimationsString(dimensions);
  return /*#__PURE__*/react.createElement("div", {
...
/* harmony default export */ var PreviewArea_PreviewArea = (PreviewArea);
;// CONCATENATED MODULE: ./src/components/Dimensions/Dimensions.jsx
...
var Dimensions = function Dimensions() {
  ...
  }, "Dimensions for the Pointer"), /*#__PURE__*/react.createElement("div", {
    className: "p-2 flex flex-col"
  }, /*#__PURE__*/react.createElement("span", null, "Directions:"), /*#__PURE__*/react.createElement("span", null, "x = ", dimensions && dimensions.x || 0), /*#__PURE__*/react.createElement("span", null, "y = ", dimensions && dimensions.y || 0), /*#__PURE__*/react.createElement("span", null, "Directions = ", dimensions && dimensions.angle || 90)));
};
/* harmony default export */ var Dimensions_Dimensions = (Dimensions);
;// CONCATENATED MODULE: ./src/components/MainPage/MainPage.jsx
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || MainPage_unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function MainPage_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return MainPage_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return MainPage_arrayLikeToArray(o, minLen); }
function MainPage_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
...
var MainPage = function MainPage() {
  var _useState = (0,react.useState)([]),
    ...
    activeEvents = _useState2[0],
    setActiveEvents = _useState2[1];
  var _useState3 = (0,react.useState)(),
    _useState4 = _slicedToArray(_useState3, 2),
    dimensions = _useState4[0],
    setDimensions = _useState4[1];
  var newDimensions = calculateDimensions(activeEvents);
  var doesIsSpriteExist = activeEvents[0] === "event-spriteClick";
  var handleFlagClick = function handleFlagClick() {
    if (activeEvents[0] === 'event-Flag') {
      setDimensions(newDimensions);
    } else return;
  };
  if (doesIsSpriteExist) {
    document.getElementById("clone_event-spriteClick").addEventListener('click', function () {
      setDimensions(newDimensions);
    });
  }
  return /*#__PURE__*/react.createElement(ActiveEventsContext.Provider, {
    value: {
  ...
  }, /*#__PURE__*/react.createElement(Sidebar_Sidebar, null), " ", /*#__PURE__*/react.createElement(MidArea_MidArea, {
    ...
    className: "w-inherit h-3/6 overflow-hidden bg-white border-t border-l border-gray-200 rounded-tl-xl ml-2"
  }, /*#__PURE__*/react.createElement("div", null, /*#__PURE__*/react.createElement(PreviewArea_PreviewArea, null))), /*#__PURE__*/react.createElement("div", {
    className: "w-inherit h-2/6 overflow-hidden bg-white border-t border-l border-gray-200 rounded-tl-xl ml-2 mt-2"
  }, /*#__PURE__*/react.createElement(Dimensions_Dimensions, null))))));
};
...
function BrowserRouter(_ref) {
  ...
  let setState = react.useCallback(newState => {
    dist_START_TRANSITION in react_namespaceObject ? react_namespaceObject[dist_START_TRANSITION](() => setStateImpl(newState)) : setStateImpl(newState);
  }, [setStateImpl]);
  react.useLayoutEffect(() => history.listen(setState), [history, setState]);
  return /*#__PURE__*/react.createElement(dist_Router, {
    basename: basename,
